    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <FadeIn direction="right" className="flex flex-col justify-center">
            ...
            <div className="flex gap-4">
              <a href="#" className="inline-block bg-primary-600 hover:bg-primary-500 text-white px-8 py-3 rounded-md font-semibold transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-primary-600/20 hover:shadow-primary-600/40 text-md">
                Jetzt Anfrage stellen
              </a>
            </div>
          </FadeIn>
          
          <FadeIn direction="left" delay={0.2} className="rounded-3xl shadow-2xl overflow-hidden bg-slate-100 h-[500px] w-full max-w-md ml-auto relative group">
            ...
            <img 
              ...
              className="w-full h-full object-cover relative z-0 group-hover:scale-105 transition-transform duration-700 ease-out"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 border-t border-slate-100">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          {/* Service 1 */}
          <FadeIn direction="up">
            <div className="p-8 bg-white border border-slate-200 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out h-full flex flex-col">
              ...
              <div className="flex gap-4 items-center">
                <a href="#" className="bg-primary-600 hover:bg-primary-500 text-white px-6 py-2.5 rounded-md font-semibold transition-all hover:-translate-y-0.5 shadow-lg shadow-primary-600/20 text-sm">
                  Therapie anfragen
                </a>
                <Link to="/leistungen" className="text-sm font-semibold hover:text-primary-600 transition-colors flex items-center uppercase tracking-wider group">
                  Mehr erfahren <ChevronRight size={16} className="ml-1 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
            </div>
          </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn direction="up">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-8">
              ...
              <div className="flex gap-8 items-center bg-white p-4 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4 border-r border-slate-100 pr-8 hover:opacity-80 transition-opacity cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            ...
            <FadeIn direction="up" delay={0.1}>
              <div className="bg-white border border-slate-200 p-8 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col gap-6">
            ...
            {/* Card 4 */}
            <FadeIn direction="up" delay={0.4} className="lg:row-start-2 lg:col-start-1">
              <div className="bg-white border border-slate-200 p-8 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col gap-6">
                <p className="text-slate-700 leading-relaxed text-sm">
            ...
            {/* Card 6 */}
            <FadeIn direction="up" delay={0.6} className="lg:row-start-2 lg:col-start-3">
              <div className="bg-white border border-slate-200 p-8 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out flex flex-col gap-6">
                <p className="text-slate-700 leading-relaxed text-sm">
          ...
          <FadeIn direction="up" delay={0.2}>
            <div className="mt-16 bg-white border border-slate-200 rounded-xl p-8 max-w-4xl mx-auto shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out">
